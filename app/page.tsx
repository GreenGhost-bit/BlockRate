          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div className="flex flex-col justify-center space-y-6">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl md:text-6xl font-bold tracking-tighter font-poppins">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full opacity-20 animate-pulse animation-delay-1000" />
            </div>
          </div>
        </div>
      </section>

      <section className="py-16 px-4 bg-gradient-to-b from-transparent to-slate-800/50">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {platformStats.map((stat, index) => {
              ...
              return (
                <Card key={index} className="bg-gradient-to-br from-slate-800 to-slate-900 border-slate-700 hover:border-green-500/50 transition-all duration-300">
        ...
        <div className="container mx-auto">
          <Card className="bg-black/50 backdrop-blur-sm border-white/20">
            <CardContent className="p-12 text-center">
              <h2 className="text-4xl md:text-5xl font-bold tracking-tighter font-poppins mb-6">
